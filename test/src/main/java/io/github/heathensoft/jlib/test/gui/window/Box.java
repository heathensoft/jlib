package io.github.heathensoft.jlib.test.gui.window;
...
import io.github.heathensoft.jlib.test.gui.window.window.BoxContent;
...
public abstract class Box implements BoxContent {
    ...
    protected void drawBorder(SpriteBatch batch, GUIGraphics graphics, int x0, int y0) {
        if (borderColor.a > 0) {
    ...
    protected void drawBackground(SpriteBatch batch, GUIGraphics graphics, int x0, int y0, int interactable) {
    ...
    protected void drawBackground(SpriteBatch batch, GUIGraphics graphics, int x0, int y0) {
