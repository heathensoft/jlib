...
public enum TextureFormat {
    ...
    INVALID(0,0,0,0,0),
    DEPTH16(GL_DEPTH_COMPONENT16,GL_DEPTH_COMPONENT,GL_UNSIGNED_SHORT,1,2),
    DEPTH32(GL_DEPTH_COMPONENT32,GL_DEPTH_COMPONENT,GL_UNSIGNED_INT,1,4),
    DEPTH32F(GL_DEPTH_COMPONENT32F,GL_DEPTH_COMPONENT,GL_FLOAT,1,4),
    DEPTH24_STENCIL8(GL_DEPTH24_STENCIL8,GL_DEPTH_STENCIL,GL_UNSIGNED_INT_24_8,2,4),
    R32_FLOAT(GL_R32F,GL_R,GL_FLOAT,1,4),
    RG32_FLOAT(GL_RG32F,GL_RG,GL_FLOAT,2,8),
    RGB32_FLOAT(GL_RGB32F,GL_RGB,GL_FLOAT,3,4),
    RGBA32_FLOAT(GL_RGBA32F,GL_RGBA,GL_FLOAT,4,8),
    R8_SIGNED_NORMALIZED(GL_R8_SNORM,GL_RED,GL_BYTE,1,1),
    R8_UNSIGNED_NORMALIZED(GL_R8,GL_RED,GL_UNSIGNED_BYTE,1,1),
    R16_SIGNED_NORMALIZED(GL_R16_SNORM,GL_RED,GL_SHORT,1,2),
    R16_UNSIGNED_NORMALIZED(GL_R16,GL_RED,GL_UNSIGNED_SHORT,1,2),
    R32_SIGNED_INTEGER(GL_R32I,GL_RED_INTEGER,GL_INT,1,4),
    R32_UNSIGNED_INTEGER(GL_R32UI,GL_RED_INTEGER,GL_UNSIGNED_INT,1,4),
    RG8_SIGNED_NORMALIZED(GL_RG8_SNORM,GL_RG,GL_BYTE,2,2),
    RG8_UNSIGNED_NORMALIZED(GL_RG8,GL_RG,GL_UNSIGNED_BYTE,2,2),
    RG16_SIGNED_NORMALIZED(GL_RG16_SNORM,GL_RG,GL_SHORT,2,4),
    RG16_UNSIGNED_NORMALIZED(GL_RG16,GL_RG,GL_UNSIGNED_SHORT,2,4),
    RGB8_SIGNED_NORMALIZED(GL_RGB8_SNORM,GL_RGB,GL_BYTE,3,1),
    RGB8_UNSIGNED_NORMALIZED(GL_RGB8,GL_RGB,GL_UNSIGNED_BYTE,3,1),
    RGB16_SIGNED_NORMALIZED(GL_RGB16_SNORM,GL_RGB,GL_SHORT,3,2),
    RGB16_UNSIGNED_NORMALIZED(GL_RGB16,GL_RGB,GL_UNSIGNED_SHORT,3,2),
    RGBA4_UNSIGNED_NORMALIZED(GL_RGBA4,GL_RGBA,GL_UNSIGNED_SHORT_4_4_4_4,4,2),
    RGBA8_SIGNED_NORMALIZED(GL_RGBA8_SNORM,GL_RGBA,GL_BYTE,4,4),
    RGBA8_UNSIGNED_NORMALIZED(GL_RGBA8,GL_RGBA,GL_UNSIGNED_BYTE,4,4);
    ...
    TextureFormat(int sized_format, int pixel_format, int pixel_data_type, int channels, int pack_alignment) {
